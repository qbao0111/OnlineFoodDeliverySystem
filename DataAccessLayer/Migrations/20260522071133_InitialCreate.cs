...
namespace DataAccessLayer.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Restaurants",
                columns: new[] { "Id", "Address", "Name", "PhoneNumber", "RestaurantOwnerId", "Status" },
                values: new object[] { 1, "University Street", "Campus Bites", "0280000001", 2, "Active" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Grilled chicken with rice", true, "Chicken Rice", 45000m, 1 },
                    { 2, "Classic milk tea", true, "Milk Tea", 25000m, 1 }
                });
